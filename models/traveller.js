...
Traveller.prototype.calculateTotalDistanceTravelled = function () {
  return this.journeys.reduce ( (totalDistance, journey) => { return totalDistance +=  journey.distance}, 0);
};

Traveller.prototype.getUniqueModesOfTransport = function () {
  let uniqueTransports = this.journeys.map ( (journey) => {
    return journey.transport;
});
  uniqueMode = [...new Set(uniqueTransports)];
  return uniqueMode;
};
